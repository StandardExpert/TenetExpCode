function StimulusGeneratorSpatial(participantNumber,trainNumber,testNumber,itemNumber,sequenceLength)
...
%                                2.Save
%--------------------------------------------------------------------------
save([participantNumber 'StimulusSpatial.mat'],'stimulusCell');
